...
const NinjaTailor = () =>{
    return(
        <div>
 <BannerSection
                    companyName={{ fname: "ninja", lname: "tailor" }}
                    title="Find your best tailor and dresses."
                    subtitle="It's the cloths and groceries you love, delivered. List your tailor or shop on foodninja"
                    align="left"
                    button={{ text: "Sign up for free", backgroundColor: "", size: "" }}
                    bgImg="assets/images/ninjatailor/bg1.jpg"
                />
